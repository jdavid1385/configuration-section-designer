...
namespace ConfigurationSectionDesigner
{
	...
	public partial class ConfigurationSectionModel : DslModeling::ModelElement
	{
		...
		/// </summary>
		public static readonly global::System.Guid AssemblyNameDomainPropertyId = new global::System.Guid(0x4ffccfd0, 0x0e27, 0x4540, 0xac, 0x49, 0xc0, 0xe7, 0x7c, 0x5a, 0x91, 0xb1);
		...
		/// The assembly name used to strongly type configuration sections in the sample
		/// configuration file
		/// </summary>
		[DslDesign::DisplayNameResource("ConfigurationSectionDesigner.ConfigurationSectionModel/AssemblyName.DisplayName", typeof(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel), "ConfigurationSectionDesigner.GeneratedCode.DomainModelResx")]
		[DslDesign::CategoryResource("ConfigurationSectionDesigner.ConfigurationSectionModel/AssemblyName.Category", typeof(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel), "ConfigurationSectionDesigner.GeneratedCode.DomainModelResx")]
		[DslDesign::DescriptionResource("ConfigurationSectionDesigner.ConfigurationSectionModel/AssemblyName.Description", typeof(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel), "ConfigurationSectionDesigner.GeneratedCode.DomainModelResx")]
		[DslModeling::DomainObjectId("4ffccfd0-0e27-4540-ac49-c0e77c5a91b1")]
		...
		/// <summary>
		/// Value handler for the ConfigurationSectionModel.AssemblyName domain property.
		/// </summary>
		internal sealed partial class AssemblyNamePropertyHandler : DslModeling::DomainPropertyValueHandler<ConfigurationSectionModel, global::System.String>
		{
			private AssemblyNamePropertyHandler() { }
		
			/// <summary>
			/// Gets the singleton instance of the ConfigurationSectionModel.AssemblyName domain property value handler.
			/// </summary>
			public static readonly AssemblyNamePropertyHandler Instance = new AssemblyNamePropertyHandler();
		
			/// <summary>
			/// Gets the Id of the ConfigurationSectionModel.AssemblyName domain property.
			/// </summary>
			public sealed override global::System.Guid DomainPropertyId
			{
				[global::System.Diagnostics.DebuggerStepThrough]
		...
		protected override void MergeRelate(DslModeling::ModelElement sourceElement, DslModeling::ElementGroup elementGroup)
		{
			...
			global::ConfigurationSectionDesigner.Comment sourceComment3 = sourceElement as global::ConfigurationSectionDesigner.Comment;
			...
			global::ConfigurationSectionDesigner.PropertyValidators sourcePropertyValidators5 = sourceElement as global::ConfigurationSectionDesigner.PropertyValidators;
			if (sourcePropertyValidators5 != null)
			{
				// Create link for path ConfigurationSectionModelHasPropertyValidators.PropertyValidators
				this.PropertyValidators = sourcePropertyValidators5;
		...
		protected override void MergeDisconnect(DslModeling::ModelElement sourceElement)
		{
			...
			if (sourceComment3 != null)
			{
				...
				foreach (DslModeling::ElementLink link in global::ConfigurationSectionDesigner.ConfigurationSectionModelHasComments.GetLinks((global::ConfigurationSectionDesigner.ConfigurationSectionModel)this, sourceComment3))
				{
					// Delete the link, but without possible delete propagation to the element since it's moving to a new location.
			...
			if (sourcePropertyValidators5 != null)
			{
				...
				foreach (DslModeling::ElementLink link in global::ConfigurationSectionDesigner.ConfigurationSectionModelHasPropertyValidators.GetLinks((global::ConfigurationSectionDesigner.ConfigurationSectionModel)this, sourcePropertyValidators5))
				{
					// Delete the link, but without possible delete propagation to the element since it's moving to a new location.
