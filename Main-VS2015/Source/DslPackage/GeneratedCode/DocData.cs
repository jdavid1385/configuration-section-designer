...
namespace ConfigurationSectionDesigner
{
	...
	/// </summary>
	internal partial class ConfigurationSectionDesignerDocData : ConfigurationSectionDesignerDocDataBase
	{
		/// <summary>
		/// Constructs a new ConfigurationSectionDesignerDocData.
		/// </summary>
		public ConfigurationSectionDesignerDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a ConfigurationSectionDesigner document in memory.
	/// </summary>
	internal abstract partial class ConfigurationSectionDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new ConfigurationSectionDesignerDocDataBase.
		/// </summary>
		protected ConfigurationSectionDesignerDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(ConfigurationSectionDesignerExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::ConfigurationSectionDesigner.ConfigurationSectionModel modelRoot = null;
			...
			global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::ConfigurationSectionDesigner.ConfigurationSectionDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::ConfigurationSectionDesigner.ConfigurationSectionModel modelRoot = this.RootElement as global::ConfigurationSectionDesigner.ConfigurationSectionModel;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDiagram diagram = diagrams[0] as global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDiagram;
					if (diagram != null)
					{
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::ConfigurationSectionDesigner.ConfigurationSectionModel modelRoot = (global::ConfigurationSectionDesigner.ConfigurationSectionModel)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::ConfigurationSectionDesigner.ConfigurationSectionDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::ConfigurationSectionDesigner.ConfigurationSectionDesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::ConfigurationSectionDesigner.ConfigurationSectionDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::ConfigurationSectionDesigner.ConfigurationSectionDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
