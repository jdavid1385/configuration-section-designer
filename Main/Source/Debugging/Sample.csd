...
<configurationSectionModel dslVersion="1.0.0.0" Id="ab30db0b-dc8b-4ce7-8183-7764183593ef" namespace="Sample" xmlSchemaNamespace="urn:sample" xmlns="http://schemas.microsoft.com/dsltools/ConfigurationSectionDesigner">
  <typeDefinitions>
  ...
  <configurationElements>
    ...
    <configurationElementCollection name="Bars" collectionType="AddRemoveClearMapAlternate" xmlItemName="bar" codeGenOptions="Indexer, AddMethod, RemoveMethod, GetItemMethods" addItemName="addBar" removeItemName="removeBar" clearItemsName="clearBars">
      <itemType>
