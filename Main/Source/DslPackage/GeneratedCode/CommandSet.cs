...
namespace ConfigurationSectionDesigner
{
	...
	internal abstract class ConfigurationSectionDesignerCommandSetBase : DslShell::CommandSet
	{
		...
		internal virtual void OnMenuValidateModel(object sender, System.EventArgs e)
		{
			...
			{
				this.CurrentConfigurationSectionDesignerDocData.ValidationController.Validate(this.CurrentConfigurationSectionDesignerDocData.Store, DslValidation::ValidationCategories.Menu);
			}
		}
