...
namespace ConfigurationSectionDesigner
{
	...
	/// </summary>
	internal abstract class ConfigurationSectionDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			modelRoot = global::ConfigurationSectionDesigner.ConfigurationSectionDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.Store, fileName, diagramFileName, schemaResolver, null /* no load-time validation */);
