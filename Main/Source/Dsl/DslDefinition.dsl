...
<Dsl dslVersion="1.0.0.0" Id="5a49b528-9c4b-4130-9093-0fb5bdef29ee" Description="Description for ConfigurationSectionDesigner.ConfigurationSectionDesigner" Name="ConfigurationSectionDesigner" DisplayName="ConfigurationSectionDesigner" Namespace="ConfigurationSectionDesigner" ProductName="Configuration Section Designer" CompanyName="Microsoft PLK" PackageGuid="9f16956e-2232-4f80-9ebb-4165929ef3ef" PackageNamespace="ConfigurationSectionDesigner" xmlns="http://schemas.microsoft.com/VisualStudio/2005/DslTools/DslDefinitionModel">
  <Classes>
    <DomainClass Id="a923fcd2-2d2e-4bd5-ac9f-296eb48b3a12" Description="The configuration section being designed, which contains all configuration elements." Name="ConfigurationSectionModel" DisplayName="Configuration Section Model" Namespace="ConfigurationSectionDesigner">
      <Properties>
    ...
    <DomainClass Id="82c927d7-0b4a-43e8-8157-463859ba944b" Description="Description for ConfigurationSectionDesigner.ConfigurationElement" Name="ConfigurationElement" DisplayName="Configuration Element" Namespace="ConfigurationSectionDesigner">
      ...
      <Properties>
        ...
        <DomainProperty Id="aa25d7d3-4d0e-46d5-a040-cb9698ce242e" Description="Determines if this configuration element has custom child elements that are not known at design-time." Name="HasCustomChildElements" DisplayName="Has Custom Child Elements" DefaultValue="false" Category="Code">
          <Type>
    ...
    <DomainClass Id="a7457ba6-e6fd-440f-b940-c6ff94b181df" Description="Description for ConfigurationSectionDesigner.ConfigurationElementCollection" Name="ConfigurationElementCollection" DisplayName="Configuration Element Collection" Namespace="ConfigurationSectionDesigner">
      ...
      <Properties>
        ...
        <DomainProperty Id="6baf61cd-20a0-4b4c-8891-8076d5b79d4f" Description="The name of the 'add' configuration element. This value is only used if CollectionType is AddRemoveClearMap or AddRemoveClearMapAlternate." Name="AddItemName" DisplayName="Add Item Name" DefaultValue="add" Category="Definition">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
        <DomainProperty Id="2aa1d68d-7956-4497-a885-939bdd3db8eb" Description="The name of the 'remove' configuration element. This value is only used if CollectionType is AddRemoveClearMap or AddRemoveClearMapAlternate." Name="RemoveItemName" DisplayName="Remove Item Name" DefaultValue="remove" Category="Definition">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
        <DomainProperty Id="ed91ace5-30dd-461d-8ae6-698b1691e7f6" Description="The name for the 'clear' configuration element. This value is only used if CollectionType is AddRemoveClearMap or AddRemoveClearMapAlternate." Name="ClearItemsName" DisplayName="Clear Items Name" DefaultValue="clear" Category="Definition">
          <Type>
            <ExternalTypeMoniker Name="/System/String" />
          </Type>
        </DomainProperty>
    ...
    <DomainClass Id="37d3b10e-35a5-4608-8bf5-5556ad9d3fe9" Description="Description for ConfigurationSectionDesigner.ConfigurationProperty" Name="ConfigurationProperty" DisplayName="Configuration Property" InheritanceModifier="Abstract" Namespace="ConfigurationSectionDesigner">
      <Properties>
        ...
        <DomainProperty Id="5c09c892-7be1-466a-b782-3f7a388bf029" Description="Determines if this is the default property collection." Name="IsDefaultCollection" DisplayName="Is Default Collection" Category="Definition">
          <Type>
            <ExternalTypeMoniker Name="/System/Boolean" />
          </Type>
        </DomainProperty>
        ...
        <DomainProperty Id="09023d9a-8496-4fa2-8c9e-92e496753669" Description="Adds custom Attributes to the property" Name="CustomAttributes" DisplayName="Custom Attributes" Kind="Calculated" Category="Metadata" IsUIReadOnly="true">
          <Attributes>
  ...
  <Relationships>
    <DomainRelationship Id="5770271a-b8f0-4768-9598-e0025796fa76" Description="Description for ConfigurationSectionDesigner.ConfigurationElementHasAttributeProperties" Name="ConfigurationElementHasAttributeProperties" DisplayName="Configuration Element Has Attribute Properties" Namespace="ConfigurationSectionDesigner" IsEmbedding="true">
      ...
      <Target>
        <DomainRole Id="e0a7c246-6b21-47e4-b537-a23bfef86401" Description="Description for ConfigurationSectionDesigner.ConfigurationElementHasAttributeProperties.AttributeProperty" Name="AttributeProperty" DisplayName="Attribute Property" PropertyName="ConfigurationElement" Multiplicity="One" PropagatesDelete="true" PropagatesCopy="true" PropertyDisplayName="Configuration Element">
          <RolePlayer>
            <DomainClassMoniker Name="AttributeProperty" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="c2b30fd0-a8b8-4b9f-abe5-fd8447c1f53e" Description="Description for ConfigurationSectionDesigner.ConfigurationElementCollectionHasItemType" Name="ConfigurationElementCollectionHasItemType" DisplayName="Configuration Element Collection Has Item Type" Namespace="ConfigurationSectionDesigner">
      <Source>
        <DomainRole Id="fb43fdc5-b8e3-4638-95c8-94f4932bef14" Description="The type of the items in this collection." Name="ConfigurationElementCollection" DisplayName="Configuration Element Collection" PropertyName="ItemType" Multiplicity="One" Category="Definition" PropertyDisplayName="Item Type">
          <RolePlayer>
    ...
    <DomainRelationship Id="12ffa767-778b-486d-a9a6-10d49f2fa642" Description="Description for ConfigurationSectionDesigner.ConfigurationElementHasElementProperties" Name="ConfigurationElementHasElementProperties" DisplayName="Configuration Element Has Element Properties" Namespace="ConfigurationSectionDesigner" IsEmbedding="true">
      <Source>
        <DomainRole Id="dd6504ef-77ca-4e58-80cd-35ce1245bcfd" Description="Description for ConfigurationSectionDesigner.ConfigurationElementHasElementProperties.ConfigurationElement" Name="ConfigurationElement" DisplayName="Configuration Element" PropertyName="ElementProperties" PropertyDisplayName="Element Properties">
          <RolePlayer>
            <DomainClassMoniker Name="ConfigurationElement" />
          </RolePlayer>
        </DomainRole>
      ...
      <Target>
        <DomainRole Id="b31a7e8b-3522-45d9-9f7c-346dbaa52f7f" Description="Description for ConfigurationSectionDesigner.ConfigurationElementHasElementProperties.ElementProperty" Name="ElementProperty" DisplayName="Element Property" PropertyName="ConfigurationElement" Multiplicity="One" PropagatesDelete="true" PropagatesCopy="true" PropertyDisplayName="Configuration Element">
          <RolePlayer>
            <DomainClassMoniker Name="ElementProperty" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="817738b5-f315-4a74-9d4f-6ec5e726ddef" Description="The type of this property." Name="ElementPropertyHasType" DisplayName="Element Property Has Type" Namespace="ConfigurationSectionDesigner">
      <Source>
        <DomainRole Id="3627555c-ddc1-4630-9fe2-6f8cbebaa348" Description="The type of this property." Name="ElementProperty" DisplayName="Element Property" PropertyName="Type" Multiplicity="One" Category="Definition" PropertyDisplayName="Type">
          <RolePlayer>
            <DomainClassMoniker Name="ElementProperty" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="44edd3cb-a478-45de-84e8-57433006cb3f" Description="The type of this property." Name="AttributePropertyHasPropertyType" DisplayName="Attribute Property Has Property Type" Namespace="ConfigurationSectionDesigner">
      <Source>
        <DomainRole Id="7d16d8ac-4ce5-4865-888a-ee530b21684a" Description="Description for ConfigurationSectionDesigner.AttributePropertyHasPropertyType.AttributeProperty" Name="AttributeProperty" DisplayName="Attribute Property" PropertyName="Type" Multiplicity="One" Category="Definition" PropertyDisplayName="Type">
          <RolePlayer>
            <DomainClassMoniker Name="AttributeProperty" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="4425730d-db79-493a-bd8e-d366b21149e0" Description="Description for ConfigurationSectionDesigner.ConfigurationPropertyHasPropertyValidator" Name="ConfigurationPropertyHasPropertyValidator" DisplayName="Configuration Property Has Property Validator" Namespace="ConfigurationSectionDesigner">
      <Source>
        <DomainRole Id="13383714-1aec-4a69-acc3-52fce0a3b2d3" Description="The validator used to validate this property." Name="ConfigurationProperty" DisplayName="Configuration Property" PropertyName="Validator" Multiplicity="ZeroOne" Category="Code" PropertyDisplayName="Validator">
          <RolePlayer>
            <DomainClassMoniker Name="ConfigurationProperty" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="44e84722-2ff6-48a1-90dc-803dfa50cca5" Description="Description for ConfigurationSectionDesigner.AttributeHasParameters" Name="AttributeHasParameters" DisplayName="Attribute Has Parameters" Namespace="ConfigurationSectionDesigner" IsEmbedding="true">
      <Source>
        <DomainRole Id="713c1da5-5c5a-4352-a10e-3e72d4f0a4b3" Description="The list of parameters for this attribute." Name="Attribute" DisplayName="Attribute" PropertyName="Parameters" PropertySetterAccessModifier="Private" PropertyDisplayName="Parameters">
          <RolePlayer>
            <DomainClassMoniker Name="Attribute" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="e49ba3bf-c523-4e21-85d1-4880fcb17f1f" Description="Description for ConfigurationSectionDesigner.ConfigurationPropertyHasAttributes" Name="ConfigurationPropertyHasAttributes" DisplayName="Configuration Property Has Attributes" Namespace="ConfigurationSectionDesigner" IsEmbedding="true">
      <Source>
        <DomainRole Id="6b1b4fb9-e6d5-4c65-af2e-c9b5e74233e2" Description="Adds custom Attributes to the property" Name="ConfigurationProperty" DisplayName="Configuration Property" PropertyName="Attributes" Category="Metadata" PropertyDisplayName="Attributes">
          <RolePlayer>
            <DomainClassMoniker Name="ConfigurationProperty" />
          </RolePlayer>
        </DomainRole>
  ...
  <Connectors>
    <Connector Id="8161bf76-7e15-418c-87cb-0326f9bb78f7" Description="Description for ConfigurationSectionDesigner.ConfigurationElementCollectionHasItemTypeConnector" Name="ConfigurationElementCollectionHasItemTypeConnector" DisplayName="Configuration Element Collection Has Item Type Connector" Namespace="ConfigurationSectionDesigner" FixedTooltipText="Configuration Element Collection Has Item Type Connector" DashStyle="Dot" TargetEndStyle="EmptyArrow" Thickness="0.015625">
      <ConnectorHasDecorators Position="SourceTop" OffsetFromShape="0" OffsetFromLine="0">
        <TextDecorator Name="NameDecorator" DisplayName="Name Decorator" DefaultText="Item Type" FontStyle="Italic" />
      </ConnectorHasDecorators>
    </Connector>
    <Connector Id="b761e9ae-2bdf-4a53-a48d-0a6e90d39d7c" Description="Description for ConfigurationSectionDesigner.ElementPropertyHasTypeConnector" Name="ElementPropertyHasTypeConnector" DisplayName="Element Property Has Type Connector" Namespace="ConfigurationSectionDesigner" FixedTooltipText="Element Property Has Type Connector" TargetEndStyle="EmptyArrow" Thickness="0.015625">
      <ConnectorHasDecorators Position="SourceTop" OffsetFromShape="0" OffsetFromLine="0">
        <TextDecorator Name="NameDecorator" DisplayName="Name Decorator" DefaultText="NameDecorator" />
      </ConnectorHasDecorators>
    </Connector>
    <Connector Id="d595d6a8-e812-4df7-a977-ee2480affeab" Description="Description for ConfigurationSectionDesigner.ConfigurationSectionPropertyHasConfigurationSectionConnector" Name="ConfigurationSectionPropertyHasConfigurationSectionConnector" DisplayName="Configuration Section Property Has Configuration Section Connector" Namespace="ConfigurationSectionDesigner" FixedTooltipText="Configuration Section Property Has Configuration Section Connector" TargetEndStyle="EmptyArrow" Thickness="0.015625" />
    <Connector Id="8c93c91b-460d-41f1-874e-843a1c2474ff" Description="Description for ConfigurationSectionDesigner.ConfigurationSectionGroupHasConfigurationSectionGroupPropertiesConnector" Name="ConfigurationSectionGroupHasConfigurationSectionGroupPropertiesConnector" DisplayName="Configuration Section Group Has Configuration Section Group Properties Connector" Namespace="ConfigurationSectionDesigner" FixedTooltipText="Configuration Section Group Has Configuration Section Group Properties Connector" TargetEndStyle="EmptyArrow" Thickness="0.015625" />
    <Connector Id="7d43d6da-858e-47af-af79-9cc09778fc0a" Description="Description for ConfigurationSectionDesigner.InheritanceConnector" Name="InheritanceConnector" DisplayName="Inheritance Connector" Namespace="ConfigurationSectionDesigner" FixedTooltipText="Inheritance Connector" TargetEndStyle="HollowArrow" Thickness="0.015625" />
  </Connectors>
  ...
  <Diagram Id="cf255b73-e2b7-4007-bc5d-80d166ffda9c" Description="The diagram representing a Configuration Section" Name="ConfigurationSectionDesignerDiagram" DisplayName="Configuration Section Diagram" Namespace="ConfigurationSectionDesigner">
    <Class>
      <DomainClassMoniker Name="ConfigurationSectionModel" />
    </Class>
    <ShapeMaps>
  ...
  <Designer FileExtension="csd" Icon="Resources\ConfigurationSectionDesigner.ico" EditorGuid="548a5f67-a0b1-4c78-84f0-508456f45157">
    <RootClass>
      <DomainClassMoniker Name="ConfigurationSectionModel" />
    </RootClass>
    ...
    <ToolboxTab TabText="Configuration Section Designer">
      ...
      <ElementTool Name="ConfigurationSectionGroup" ToolboxIcon="Resources\ConfigurationSectionGroup.bmp" Caption="Configuration Section Group" Tooltip="Defines a Configuration Section Group" HelpKeyword="ConfigurationSectionGroup">
        <DomainClassMoniker Name="ConfigurationSectionGroup" />
      </ElementTool>
    </ToolboxTab>
