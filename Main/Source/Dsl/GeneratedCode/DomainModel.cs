...
namespace ConfigurationSectionDesigner
{
	...
	public partial class ConfigurationSectionDesignerDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			if (createElementMap == null)
			{
				...
				createElementMap.Add(typeof(ConfigurationSectionDesignerDiagram), 23);
				createElementMap.Add(typeof(ConfigurationElementCollectionHasItemTypeConnector), 24);
				createElementMap.Add(typeof(ElementPropertyHasTypeConnector), 25);
				createElementMap.Add(typeof(ConfigurationSectionPropertyHasConfigurationSectionConnector), 26);
				createElementMap.Add(typeof(ConfigurationSectionGroupHasConfigurationSectionGroupPropertiesConnector), 27);
				createElementMap.Add(typeof(InheritanceConnector), 28);
				createElementMap.Add(typeof(ConfigurationShape), 29);
				createElementMap.Add(typeof(ConfigurationSectionShape), 30);
				createElementMap.Add(typeof(ConfigurationElementCollectionShape), 31);
				createElementMap.Add(typeof(ConfigurationElementShape), 32);
				createElementMap.Add(typeof(ConfigurationSectionGroupShape), 33);
			}
			int index;
			...
			switch (index)
			{
				...
				case 23: return new ConfigurationSectionDesignerDiagram(partition, propertyAssignments);
				case 24: return new ConfigurationElementCollectionHasItemTypeConnector(partition, propertyAssignments);
				case 25: return new ElementPropertyHasTypeConnector(partition, propertyAssignments);
				case 26: return new ConfigurationSectionPropertyHasConfigurationSectionConnector(partition, propertyAssignments);
				case 27: return new ConfigurationSectionGroupHasConfigurationSectionGroupPropertiesConnector(partition, propertyAssignments);
				case 28: return new InheritanceConnector(partition, propertyAssignments);
				case 29: return new ConfigurationShape(partition, propertyAssignments);
				case 30: return new ConfigurationSectionShape(partition, propertyAssignments);
				case 31: return new ConfigurationElementCollectionShape(partition, propertyAssignments);
				case 32: return new ConfigurationElementShape(partition, propertyAssignments);
				case 33: return new ConfigurationSectionGroupShape(partition, propertyAssignments);
				default: return null;
			}
		}
	...
	/// </summary>
	public partial class ConfigurationSectionDesignerCopyClosureBase : DslModeling::IElementVisitorFilter
	{
		/// <summary>
		/// DomainRoles
		/// </summary>
		...
		/// Constructor
		/// </summary>
		public ConfigurationSectionDesignerCopyClosureBase()
		{
			#region Initialize DomainData Table
			DomainRoles.Add(global::ConfigurationSectionDesigner.ConfigurationElementHasAttributeProperties.AttributePropertyDomainRoleId, true);
			DomainRoles.Add(global::ConfigurationSectionDesigner.ConfigurationElementHasElementProperties.ElementPropertyDomainRoleId, true);
