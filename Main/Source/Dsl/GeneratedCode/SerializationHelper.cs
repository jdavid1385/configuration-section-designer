...
{
	/// <summary>
	/// Partial class to handle serialization of ConfigurationSectionModel instance as a root-level XML element.
	/// </summary>
	public partial class ConfigurationSectionModelSerializer
	{
		/// <summary>
		/// Public ReadRootElement() method that deserializes a root-level ConfigurationSectionModel instance from XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">In-memory ConfigurationSectionModel instance that will get the deserialized data.</param>
				...
				if (schemaResolver != null)
				{
					...
					if (!string.IsNullOrEmpty(targetNamespace))
					{
						...
						if (schemas != null && schemas.Count > 0)
						{
							if (schemas.Count > 1)
							{
								ConfigurationSectionDesignerSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
							}
							...
							ConfigurationSectionDesignerSerializationBehaviorSchemaValidationCallback validationCallback = new ConfigurationSectionDesignerSerializationBehaviorSchemaValidationCallback(serializationContext);
						...
						{
							ConfigurationSectionDesignerSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
						}
					}
				}
		...
		private static void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						ConfigurationSectionDesignerSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					ConfigurationSectionDesignerSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		/// </summary>
		private sealed class ConfigurationSectionDesignerSerializationBehaviorSchemaValidationCallback
		{
			...
			internal ConfigurationSectionDesignerSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					ConfigurationSectionDesignerSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
	
		/// <summary>
		/// Public WriteRootElement() method that serializes a root-level ConfigurationSectionModel instance to XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">ConfigurationSectionModel instance that will be serialized.</param>
		...
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/ConfigurationSectionDesigner";
...
{
	/// <summary>
	/// Partial class to handle serialization of ConfigurationSectionDesignerDiagram instance as a root-level XML element.
	/// </summary>
	public partial class ConfigurationSectionDesignerDiagramSerializer
	{
		/// <summary>
		/// Public ReadRootElement() method that deserializes a root-level ConfigurationSectionDesignerDiagram instance from XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">In-memory ConfigurationSectionDesignerDiagram instance that will get the deserialized data.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="schemaResolver">An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).</param>
		public override void ReadRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader, DslModeling::ISchemaResolver schemaResolver)
		{
		...
		/// <summary>
		/// Public WriteRootElement() method that serializes a root-level ConfigurationSectionDesignerDiagram instance to XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">ConfigurationSectionDesignerDiagram instance that will be serialized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			#region Check Parameters
...
{
	/// <summary>
	/// Helper class for serializing and deserializing ConfigurationSectionDesigner models.
	/// </summary>
	public abstract partial class ConfigurationSectionDesignerSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected ConfigurationSectionDesignerSerializationHelperBase() { }
		#endregion
	
		/// <summary>
		/// Loads a ConfigurationSectionModel instance into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new ConfigurationSectionModel instance will be created into the default partition of this store.</param>
		/// <param name="fileName">Name of the file from which the ConfigurationSectionModel instance will be deserialized.</param>
		...
		/// </param>
		/// <returns>The loaded ConfigurationSectionModel instance.</returns>
		public virtual ConfigurationSectionModel LoadModel(DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null) 
		...
		/// <summary>
		/// Loads a ConfigurationSectionModel instance into the default partition of the given store.
		/// </summary>
		...
		/// </param>
		/// <returns>The loaded ConfigurationSectionModel instance.</returns>
		public virtual ConfigurationSectionModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a ConfigurationSectionModel instance.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="partition">Partition in which the new ConfigurationSectionModel instance will be created.</param>
		/// <param name="fileName">Name of the file from which the ConfigurationSectionModel instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		/// </param>
		/// <returns>The loaded ConfigurationSectionModel instance.</returns>
		public virtual ConfigurationSectionModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			...
			{
				throw new global::System.InvalidOperationException(ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			
			ConfigurationSectionModel modelRoot = null;
			DslModeling::DomainClassXmlSerializer modelRootSerializer = this.Directory.GetSerializer(ConfigurationSectionModel.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for ConfigurationSectionModel!");
			if (modelRootSerializer != null)
			{
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true))
					{
						...
						// Set up MonikerResolver for ConfigurationSectionDesigner.
						...
						if (fileStream.Length > 5)
						{
							...
							try
							{
								using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
								{
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as ConfigurationSectionModel;
									if (modelRoot != null && !serializationResult.Failed)
									{
										// Note: the actual instance we get back from TryCreateInstance() can be of a derived type of ConfigurationSectionModel,
		...
		/// <param name="modelRoot">ConfigurationSectionModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the ConfigurationSectionModel instance will be saved.</param>
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, ConfigurationSectionModel modelRoot, string fileName)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, ConfigurationSectionModel modelRoot, string fileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="modelRoot">ConfigurationSectionModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the ConfigurationSectionModel instance will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the ConfigurationSectionModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, ConfigurationSectionModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="encoding">Encoding to use when saving the ConfigurationSectionModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized ConfigurationSectionModel instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, ConfigurationSectionModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
		...
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">ConfigurationSectionDesignerDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the diagram.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized ConfigurationSectionDesignerDiagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, ConfigurationSectionDesignerDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
		...
		/// <summary>
		/// Helper method to create and initialize a new ConfigurationSectionModel.
		/// </summary>
		internal protected virtual ConfigurationSectionModel CreateModelHelper(DslModeling::Partition modelPartition)
		{
			ConfigurationSectionModel model = new ConfigurationSectionModel(modelPartition);
			return model;
		}
		
		/// <summary>
		/// Loads a ConfigurationSectionModel instance and its associated diagram file into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new ConfigurationSectionModel instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the ConfigurationSectionModel instance will be deserialized.</param>
		/// <param name="diagramFileName">Name of the file from which the ConfigurationSectionDesignerDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		/// </param>
		...
		/// </param>
		/// <returns>The loaded ConfigurationSectionModel instance.</returns>
		public virtual ConfigurationSectionModel LoadModelAndDiagram(DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
		...
		/// <summary>
		/// Loads a ConfigurationSectionModel instance and its associated diagram file into the default partition of the given store.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="store">The new ConfigurationSectionModel instance will be created into the default partition of this store.</param>
		/// <param name="modelFileName">Name of the file from which the ConfigurationSectionModel instance will be deserialized.</param>
		...
		/// </param>
		/// <returns>The loaded ConfigurationSectionModel instance.</returns>
		public virtual ConfigurationSectionModel LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null)
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a ConfigurationSectionModel instance and its associated diagram file.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="modelPartition">Partition in which the new ConfigurationSectionModel instance will be created.</param>
		/// <param name="modelFileName">Name of the file from which the ConfigurationSectionModel instance will be deserialized.</param>
		/// <param name="diagramPartition">Partition in which the new ConfigurationSectionDesignerDiagram instance will be created.</param>
		/// <param name="diagramFileName">Name of the file from which the ConfigurationSectionDesignerDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual ConfigurationSectionModel LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			...
			ConfigurationSectionModel modelRoot;
			...
			ConfigurationSectionDesignerDiagram diagram = null;
			DslModeling::DomainClassXmlSerializer diagramSerializer = this.Directory.GetSerializer(ConfigurationSectionDesignerDiagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(diagramSerializer != null, "Cannot find serializer for ConfigurationSectionDesignerDiagram");
			if (diagramSerializer != null)
			{
						...
						using (DslModeling::Transaction t = diagramPartition.Store.TransactionManager.BeginTransaction("LoadDiagram", true))
						{
							...
							if (fileStream.Length > 5)
							{
								...
								try
								{
									...
									{
										reader.MoveToContent();
										diagram = diagramSerializer.TryCreateInstance(serializationContext, reader, diagramPartition) as ConfigurationSectionDesignerDiagram;
										if (diagram != null)
										{
											// Note: the actual instance we get back from TryCreateInstance() can be of a derived type of ConfigurationSectionDesignerDiagram,
											// so we need to find the correct serializer instance to deserialize the element properly.
		...
		/// <summary>
		/// Helper method to create and initialize a new ConfigurationSectionDesignerDiagram.
		/// </summary>
		...
		internal protected virtual ConfigurationSectionDesignerDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			ConfigurationSectionDesignerDiagram diagram = new ConfigurationSectionDesignerDiagram(diagramPartition);
			return diagram;
		}
		...
		/// <param name="diagram">ConfigurationSectionDesignerDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, ConfigurationSectionModel modelRoot, string modelFileName, ConfigurationSectionDesignerDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, ConfigurationSectionModel modelRoot, string modelFileName, ConfigurationSectionDesignerDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given ConfigurationSectionModel and ConfigurationSectionDesignerDiagram to the given files, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="modelRoot">ConfigurationSectionModel instance to be saved.</param>
		/// <param name="modelFileName">Name of the file in which the CanonicalSampleRoot instance will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, ConfigurationSectionModel modelRoot, string modelFileName, ConfigurationSectionDesignerDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">ConfigurationSectionDesignerDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, ConfigurationSectionDesignerDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, ConfigurationSectionDesignerDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given ConfigurationSectionDesignerDiagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">ConfigurationSectionDesignerDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, ConfigurationSectionDesignerDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual string GetSerializedModelString(global::ConfigurationSectionDesigner.ConfigurationSectionModel modelRoot, global::System.Text.Encoding encoding)
		{
		...
		/// <summary>
		/// DomainXmlSerializerDirectory instance used by this ConfigurationSectionDesignerSerializationHelper class.
		/// </summary>
		...
		protected virtual DslModeling::DomainXmlSerializerDirectory Directory
		{
			...
			get
			{
				if (this.directory == null)
				{
					...
					directory.AddBehavior(ConfigurationSectionDesignerSerializationBehavior.Instance);
				}
		...
		internal protected virtual global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> GetMonikerResolvers(DslModeling::Store store)
		{
			...
			result.Add(ConfigurationSectionDesignerDomainModel.DomainModelId, new ConfigurationSectionDesignerSerializationBehaviorMonikerResolver(store, this.Directory));
			return result;
		}
	...
	/// Helper class for serializing and deserializing ConfigurationSectionDesigner models.
	/// </summary>
	public sealed partial class ConfigurationSectionDesignerSerializationHelper : ConfigurationSectionDesignerSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private ConfigurationSectionDesignerSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static ConfigurationSectionDesignerSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static ConfigurationSectionDesignerSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (ConfigurationSectionDesignerSerializationHelper.instance == null)
					ConfigurationSectionDesignerSerializationHelper.instance = new ConfigurationSectionDesignerSerializationHelper();
				return ConfigurationSectionDesignerSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace ConfigurationSectionDesigner
{
	...
	public partial class ConfigurationSectionModel
	{
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = ConfigurationSectionDesignerSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									ConfigurationSectionDesignerDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
