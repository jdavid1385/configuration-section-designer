...
namespace ConfigurationSectionDesigner
{
	...
	/// </remarks>
	public partial class ConfigurationSectionDesignerHelpKeywordHelper : ConfigurationSectionDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ConfigurationSectionDesignerHelpKeywordHelper.
		/// </summary>
		protected ConfigurationSectionDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ConfigurationSectionDesignerHelpKeywordHelper.
		/// </summary>
		public static ConfigurationSectionDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ConfigurationSectionDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ConfigurationSectionDesignerHelpKeywordHelperBase.
		/// </summary>
		protected ConfigurationSectionDesignerHelpKeywordHelperBase()
			: base() { }
