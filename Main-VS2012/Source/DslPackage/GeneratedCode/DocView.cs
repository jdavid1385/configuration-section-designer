...
namespace ConfigurationSectionDesigner
{
	...
	/// </summary>
	internal partial class ConfigurationSectionDesignerDocView : ConfigurationSectionDesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new ConfigurationSectionDesignerDocView.
		/// </summary>
		public ConfigurationSectionDesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ConfigurationSectionDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ConfigurationSectionDesignerDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			ConfigurationSectionDesignerDocDataBase docData = this.DocData as ConfigurationSectionDesignerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ConfigurationSectionDesignerDocViewBase should be an ConfigurationSectionDesignerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::ConfigurationSectionDesigner.ConfigurationSectionDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::ConfigurationSectionDesigner.ConfigurationSectionDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ConfigurationSectionDesignerDiagramMenu;
			}
		}
			...
			if(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::ConfigurationSectionDesigner.ConfigurationSectionDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
