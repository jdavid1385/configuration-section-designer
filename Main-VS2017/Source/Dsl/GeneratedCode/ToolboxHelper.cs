...
namespace ConfigurationSectionDesigner
{
	...
	public abstract class ConfigurationSectionDesignerToolboxHelperBase
	{
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "ConfigurationSectionDesigner.ConfigurationSectionToolboxItem":
					// Add ConfigurationSection shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"ConfigurationSectionDesigner.ConfigurationSectionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"ConfigurationSectionDesigner.Configuration Section DesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
					...
					break;
				case "ConfigurationSectionDesigner.ConfigurationElementToolboxItem":
					// Add ConfigurationElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"ConfigurationSectionDesigner.ConfigurationElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "ConfigurationSectionDesigner.ConfigurationElementCollectionToolboxItem":
					// Add ConfigurationElementCollection shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"ConfigurationSectionDesigner.ConfigurationElementCollectionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "ConfigurationSectionDesigner.CollectionItemTypeToolboxItem":

					// Add CollectionItemType connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"ConfigurationSectionDesigner.CollectionItemTypeToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "ConfigurationSectionDesigner.ConfigurationSectionGroupToolboxItem":
					// Add ConfigurationSectionGroup shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"ConfigurationSectionDesigner.ConfigurationSectionGroupToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "ConfigurationSectionDesigner.CommentToolboxItem":
					// Add Comment shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"ConfigurationSectionDesigner.CommentToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::ConfigurationSectionDesigner.Comment.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "ConfigurationSectionDesigner.CommentConnectorToolboxItem":

					// Add CommentConnector connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"ConfigurationSectionDesigner.CommentConnectorToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::ConfigurationSectionDesigner.ConfigurationSectionDesignerDomainModel));
